 ...
 */
public class MedLayerServerResource extends BaseServerResource {
 
  public MedLayerServerResource() {
    super();
  }

  @Get
  public JsonRepresentation readMedlayerValues() {
    MedLayerAppManager cManager = new MedLayerAppManager();
    ReturnMessage response = cManager.readMedLayerAppAllValues(itemKey);
