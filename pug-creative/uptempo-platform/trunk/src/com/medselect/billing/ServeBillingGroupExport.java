...
/**
   * Get BillingGroup export file blob key from the database on demand.
  ...
  private BlobKey doGetBlobKey() throws IOException, FileNotFoundException, JSONException {
    ...
    AppEngineFile file = fileService.createNewBlobFile("application/json", "billinggroups.json");
    boolean lock = true;
    ...
    ReturnMessage response = billinggroupManager.readBillinggroupValues(billinggroupParams, null);
