...
/**
 * Class to serve BillingOffice export.
 * @author karlo.smid@gmail.com
 */
public class ServeBillingOfficeExport extends HttpServlet {
  private BlobstoreService blobstoreService = BlobstoreServiceFactory.getBlobstoreService();
  protected static final Logger LOGGER = Logger.getLogger(ServeBillingOfficeExport.class.getName());

/**
   * Serves BillingOffice export from the database.
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      response.setHeader("Content-Disposition", "attachment; filename=billingOfficeExport.json");
...
/**
   * Get BillingOffice export file blob key from the database on demand.
  ...
  private BlobKey doGetBlobKey() throws IOException, FileNotFoundException, JSONException {
    ...
    AppEngineFile file = fileService.createNewBlobFile("application/json", "billingoffices.json");
    boolean lock = true;
