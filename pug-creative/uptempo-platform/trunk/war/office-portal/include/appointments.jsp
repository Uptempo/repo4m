                ...
                <div class="control-group">
                  <div class="controls">
                    <select class="input-large m-wrap" tabindex="1">
                      <option value="Category 1">Dr. Perjan Duro</option>
                      <option value="Category 2">Doctor 2</option>
                      <option value="Category 3">Doctor 5</option>
                      <option value="Category 4">Doctor 4</option>
                    </select>
                  </div>
                </div>                
              </h3>
                  ...
                  <table class="table table-striped table-bordered" id="sample_1">
                    ...
                    <tbody>
                      <tr class="odd gradeX">
                        ...
                        <td class="center hidden-phone">02.03.2013 15:00</td>
                        <td>Jhone doe</td>
                        <td>
