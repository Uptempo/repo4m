...
/**
 * Class to serve StaticList export.
 * @author karlo.smid@gmail.com
 */
public class ServeStaticListExport extends HttpServlet {
  private BlobstoreService blobstoreService = BlobstoreServiceFactory.getBlobstoreService();
  protected static final Logger LOGGER = Logger.getLogger(ServeStaticListExport.class.getName());

/**
   * Serves StaticList export from the database.
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      response.setHeader("Content-Disposition", "attachment; filename=staticlistExport.json");
...
/**
   * Get StaticList export file blob key from the database on demand.
  ...
  private BlobKey doGetBlobKey() throws IOException, FileNotFoundException, JSONException {
    ...
    AppEngineFile file = fileService.createNewBlobFile("application/json", "staticlists.json");
    boolean lock = true;
