<head>
  ...
  <title>Uptempo Appointment System Registration</title>
  ...
  <script type="text/javascript" src="service/loadconfig.js?a=APPOINTMENT"></script>
  ...
  <script type="text/javascript" src="server/js/office-signup.js"></script>
