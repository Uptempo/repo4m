...
-->
      ...
      <li class="has-sub">
        <a href="#" class="" id="appointments-link">
          <span class="icon-box"> <i class="icon-calendar"></i></span> Appointments
        </a>
      </li>                           
      <li class="has-sub">
        <a href="#" class="" id="doctors-link">
          <span class="icon-box"><i class="icon-user-md"></i></span> Doctors
